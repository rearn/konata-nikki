...
class test_konata(unittest.TestCase):
	...
	def test_write_content(self):
		...
		self.assertEqual(ret['contents'][0]['updated'], dict['updated'])
		self.assertEqual(ret['contents'][0]['title'], dict['title'])
		self.assertEqual(ret['contents'][0]['context'], dict['context'])
